...
export default function NewPagePage() {
  ...
  const validateForm = () => {
    ...
    if (formData.keywords && formData.keywords.split(",").some(k => k.trim().length > 50)) {
      newErrors.keywords = "Each keyword must be less than 50 characters";
    }
    
    if (formData.ogImage && !isValidUrl(formData.ogImage)) {
      newErrors.ogImage = "Please enter a valid URL";
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (errorData.error === "Page with this slug already exists") {
          ...
          setErrors({ submit: errorData.error || "Failed to create page" });
        }
      }
    } catch (error) {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Create and customize your website pages</p>
          </div>
        </div>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="travel, dubai, tours, luxury (comma separated)"
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={errors.ogImage ? "border-red-500" : ""}
              />
              {errors.ogImage && <p className="text-sm text-red-500">{errors.ogImage}</p>}
            </div>
          </CardContent>
        </Card>
